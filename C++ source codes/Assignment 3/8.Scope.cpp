/*Program to define a local class.Also define a global variable with
  same name as that of member variable.Read and display the data for
  global and data member*/
